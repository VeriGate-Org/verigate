...
/**
 * Request DTO for {@code POST /v1/cipc/director-result}. {@code OutputFormat} is
 * always {@code JSON} for this integration — no PDF report is needed, so
 * {@code PDFEncryptionPassword} is never populated.
 */
public record DirectorResultRequestDto(
