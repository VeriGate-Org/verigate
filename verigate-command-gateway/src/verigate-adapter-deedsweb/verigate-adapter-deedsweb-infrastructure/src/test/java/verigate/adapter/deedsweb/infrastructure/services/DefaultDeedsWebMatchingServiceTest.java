...
package verigate.adapter.deedsweb.infrastructure.services;
...
class DefaultDeedsWebMatchingServiceTest {

    @Mock
    private DeedsWebApiAdapter mockApiAdapter;

    private DefaultDeedsWebMatchingService service;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        service = new DefaultDeedsWebMatchingService(mockApiAdapter);
    }
