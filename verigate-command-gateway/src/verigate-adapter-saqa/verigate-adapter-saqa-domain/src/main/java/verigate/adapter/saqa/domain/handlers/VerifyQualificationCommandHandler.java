...
package verigate.adapter.saqa.domain.handlers;
...
/**
 * Command handler interface for processing qualification verification commands
 * using the SAQA registry.
 */
public interface VerifyQualificationCommandHandler
   ...
   *
   * @param command the verification command containing qualification details to verify
