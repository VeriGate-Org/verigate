 ...
 */
@FunctionalInterface
public interface LambdaApiGatewayThrowingFunction<E extends RuntimeException> {
   ...
   */
  ApiGatewayResponse apply(APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent) throws E;
}
