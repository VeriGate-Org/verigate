...
public class DefaultDeedsWebMatchingService implements DeedsWebMatchingService {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(DefaultDeedsWebMatchingService.class.getName());

  private final DeedsWebApiAdapter apiAdapter;

  public DefaultDeedsWebMatchingService(DeedsWebApiAdapter apiAdapter) {
