...
package verigate.adapter.opensanctions.infrastructure.mocks;

import domain.exceptions.PermanentException;
import domain.exceptions.TransientException;
import verigate.adapter.opensanctions.domain.models.*;
 ...
 */
public class MockOpenSanctionsMatchingService implements OpenSanctionsMatchingService {

    private static final Logger LOGGER = Logger.getLogger(MockOpenSanctionsMatchingService.class.getName());
