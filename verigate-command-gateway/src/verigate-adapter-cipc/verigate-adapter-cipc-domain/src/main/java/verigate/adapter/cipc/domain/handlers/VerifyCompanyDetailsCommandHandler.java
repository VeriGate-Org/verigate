...
package verigate.adapter.cipc.domain.handlers;
...
/**
 * Command handler interface for processing verify company details commands
 * using the CIPC public data API.
 */
public interface VerifyCompanyDetailsCommandHandler
   ...
   *
   * @param command the verification command containing company details to verify
