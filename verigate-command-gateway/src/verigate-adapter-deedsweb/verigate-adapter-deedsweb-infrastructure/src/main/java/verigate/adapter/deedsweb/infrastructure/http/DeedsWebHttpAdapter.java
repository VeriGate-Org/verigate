...
public class DeedsWebHttpAdapter {
  ...
  private static final Logger LOGGER = Logger.getLogger(DeedsWebHttpAdapter.class.getName());
  private static final String API_KEY_HEADER = "Authorization";
  private static final String CONTENT_TYPE_HEADER = "Content-Type";
  private static final String APPLICATION_JSON = "application/json";

  protected final HttpClient httpClient;
  protected final DeedsWebApiConfiguration config;
   ...
   */
  public DeedsWebHttpAdapter(DeedsWebApiConfiguration config) {
    this.config = config;
    this.httpClient =
