...
package verigate.adapter.income.domain.handlers;
...
/**
 * Command handler interface for processing income verification commands.
 */
public interface VerifyIncomeCommandHandler
   ...
   *
   * @param command the verification command containing income details to verify
