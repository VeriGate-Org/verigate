...
package verigate.adapter.employment.domain.handlers;
...
/**
 * Command handler interface for processing employment verification commands.
 */
public interface VerifyEmploymentCommandHandler
   ...
   *
   * @param command the verification command containing employment details to verify
