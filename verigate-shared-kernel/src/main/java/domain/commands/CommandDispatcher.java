...
/**
 * The {@code CommandDispatcher} interface defines a generic contract for dispatching
 ...
 */
public interface CommandDispatcher<CommandT> {
   ...
   *     appropriately.
   */
  void dispatch(CommandT command);
}
