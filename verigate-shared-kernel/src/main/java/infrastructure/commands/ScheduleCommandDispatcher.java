...
/**
 * The {@code ScheduleCommandDispatcher} interface defines a generic contract for dispatching
 ...
 *
 */
public interface ScheduleCommandDispatcher<CommandT> extends CommandDispatcher<CommandT> {}
