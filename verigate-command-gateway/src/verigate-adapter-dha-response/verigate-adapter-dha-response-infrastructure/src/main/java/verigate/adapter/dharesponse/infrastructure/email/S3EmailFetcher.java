...
/** Fetches raw email content from S3. */
public class S3EmailFetcher
    implements DefaultProcessDhaResponseCommandHandler.EmailFetcher {

  private static final Logger logger =
      LoggerFactory.getLogger(S3EmailFetcher.class);
