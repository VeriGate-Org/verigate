...
public class AwsInfrastructureProber {
  ...
  public AwsInfrastructureProber(
      ...
      @Value("${verigate.verification.command-store.table-name:verigate-command-store}") String commandStoreTable,
      ...
      @Value("${verigate.cases.table-name:verigate-cases}") String casesTable,
      @Value("${verigate.monitoring.subjects-table-name:verigate-monitored-subjects}") String monitoringSubjectsTable,
