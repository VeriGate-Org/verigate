...
const tabs: { id: Tab; label: string; icon: typeof Briefcase }[] = [
  { id: "verify", label: "Verify", icon: Briefcase },
...
export default function EmploymentPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === "verify" && <EmploymentVerification />}
      {activeTab === "history" && <EmploymentHistory />}
      {activeTab === "batch" && <BatchUploadPlaceholder serviceName="employment verification" />}
    </div>
  );
}
