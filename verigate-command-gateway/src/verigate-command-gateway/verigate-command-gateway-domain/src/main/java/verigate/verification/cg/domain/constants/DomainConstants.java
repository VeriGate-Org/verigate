...
public class DomainConstants {
  ...
  public static final Map<VerificationType, String> VERIFICATION_TYPE_TO_QUEUE_NAME_MAP =
      Map.ofEntries(
          ...
          Map.entry(VerificationType.VERIFICATION_OF_PERSONAL_DETAILS,
              "WORLDCHECK_ADAPTER_QUEUE_NAME"),
          ...
          Map.entry(VerificationType.PROPERTY_OWNERSHIP_VERIFICATION,
              "DEEDSWEB_ADAPTER_QUEUE_NAME"),
          Map.entry(VerificationType.EMPLOYMENT_VERIFICATION, "EMPLOYMENT_ADAPTER_QUEUE_NAME"),
          Map.entry(VerificationType.NEGATIVE_NEWS_SCREENING,
              "NEGATIVENEWS_ADAPTER_QUEUE_NAME"),
          Map.entry(VerificationType.FRAUD_WATCHLIST_SCREENING,
              "FRAUDWATCHLIST_ADAPTER_QUEUE_NAME"),
