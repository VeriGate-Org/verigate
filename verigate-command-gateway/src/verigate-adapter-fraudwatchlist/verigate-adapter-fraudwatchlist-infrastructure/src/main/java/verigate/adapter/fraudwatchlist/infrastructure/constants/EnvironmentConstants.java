...
public class EnvironmentConstants {
  ...
  // HTTP Configuration
  public static final String FRAUDWATCHLIST_HTTP_TIMEOUT_SECONDS =
      "FRAUDWATCHLIST_HTTP_TIMEOUT_SECONDS";
  public static final String FRAUDWATCHLIST_HTTP_RETRY_ATTEMPTS =
      "FRAUDWATCHLIST_HTTP_RETRY_ATTEMPTS";
  public static final String FRAUDWATCHLIST_HTTP_RETRY_DELAY_MS =
      "FRAUDWATCHLIST_HTTP_RETRY_DELAY_MS";
  ...
  public static final String FRAUDWATCHLIST_ENABLE_REQUEST_LOGGING =
      "FRAUDWATCHLIST_ENABLE_REQUEST_LOGGING";
  public static final String FRAUDWATCHLIST_ENABLE_RESPONSE_LOGGING =
      "FRAUDWATCHLIST_ENABLE_RESPONSE_LOGGING";
