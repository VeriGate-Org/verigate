...
package verigate.adapter.dha.domain.handlers;
...
/**
 * Command handler interface for processing identity verification commands
 * using the DHA identity verification API.
 */
public interface VerifyIdentityCommandHandler
   ...
   *
   * @param command the verification command containing identity details to verify
