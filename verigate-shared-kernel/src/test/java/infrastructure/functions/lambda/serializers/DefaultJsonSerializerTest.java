...
final class DefaultJsonSerializerTest {

  @Test
  void testSerializeWithStaticTyping() {

    var serializer = new DefaultJsonSerializer(); // no withTyping();
  ...
  void testDeserializeWithStaticTyping() {
    ...
    final var serializer = new DefaultJsonSerializer(); // no withTyping();
